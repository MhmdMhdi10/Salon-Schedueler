...
- [ ] 1. Tooling and design tokens (web)
  - [ ] 1.1 Add additive dependencies and configure Tailwind CSS v3
  ...
  - [ ] 1.2 Author the global token stylesheet and import it once in `main.tsx`
  ...
  - [ ] 1.3 Self-host Vazirmatn and define color modes
  ...
  - [ ] 1.4 Export a shared TS token object for React Native parity
    - A pure `tokens.ts` shape (color/space/radius/type values only) consumable by both web and the mobile theme
    - _Requirements: 1.1, 6.1_

- [ ] 2. Core accessible component primitives (R2 inventory), with component tests + axe
  - [ ] 2.1 Buttons, inputs, and form fields
  ...
  - [ ] 2.2 Selection and overlay primitives on Radix
  ...
  - [ ] 2.3 Display, feedback, and status components
  ...
  - [ ] 2.4 Jalali date picker, time/slot components, and formatters
  ...
  - [ ] 2.5 Component tests + axe checks for every primitive
...
- [ ] 3. App shell, layout, header, navigation, and theme + language/RTL handling
  - [ ] 3.1 ThemeProvider with persisted light/dark and OS fallback
  ...
  - [ ] 3.2 App shell, landmarks, and responsive layout
  ...
  - [ ] 3.3 Customer funnel shell and admin shell
  ...
  - [ ] 3.4 Route-level code splitting and loading UI
...
- [ ] 4. SEO and rendering foundation
  - [ ] 4.1 HelmetProvider + `<SeoHead>` and `<JsonLd>` components
  ...
  - [ ] 4.4 Public-route prerender (SSG) build step
  ...
  - [ ] 4.5 PWA manifest + service worker polish
...
- [ ] 5. Public marketing and salon-profile pages (indexable, SEO-complete)
  - [ ] 5.1 Marketing home at `/`
  ...
  - [ ] 5.2 Public salon profile at `/s/:slug`
  ...
  - [ ] 5.3 (Optional) discovery and legal pages
...
- [ ] 6. Customer pages redesign (one sub-task per page)
  - [ ] 6.1 Auth page (`AuthPage.tsx`)
  ...
  - [ ] 6.2 QR landing (`QrLandingPage.tsx`)
  ...
  - [ ] 6.3 Availability (`AvailabilityPage.tsx`)
  ...
  - [ ] 6.4 Booking confirm (`BookingConfirmPage.tsx`)
  ...
  - [ ] 6.5 Booking success (`BookingSuccessPage.tsx`)
...
- [ ] 7. Admin pages redesign (one sub-task per page)
  - [ ] 7.1 Configuration (`admin/ConfigurationPage.tsx`)
  ...
  - [ ] 7.2 Calendar (`admin/CalendarPage.tsx`)
  ...
  - [ ] 7.3 Analytics (`admin/AnalyticsPage.tsx`)
...
- [ ] 8. Mobile React Native screens redesign (one sub-task per screen)
  - [ ] 8.1 RN ThemeProvider from shared tokens
    - Map `tokens.ts` to an RN theme (color/space/radius/type); RTL + Persian typography baseline; no logic changes
    - _Requirements: 6.1, 6.5_
  - [ ] 8.2 AuthScreen (`screens/AuthScreen.tsx`)
  ...
  - [ ] 8.3 QrScanScreen (`screens/QrScanScreen.tsx`)
  ...
  - [ ] 8.4 Availability/booking screen
...
- [ ] 9. Localization, RTL, Jalali, numerals, and Rial polish pass (all UI)
  - [ ] 9.1 i18n catalog completeness
  ...
  - [ ] 9.2 Jalali + numerals + Rial everywhere
...
- [ ] 10. Accessibility pass (WCAG 2.2 AA targets)
  - [ ] 10.1 Keyboard, focus, and landmarks
  ...
  - [ ] 10.2 Contrast, text alternatives, and forms
  ...
  - [ ] 10.3 Automated a11y in CI + manual-testing note
...
- [ ] 11. Performance pass (Core Web Vitals)
  - [ ] 11.1 Bundle and code-split verification
    - Confirm funnel/admin/charts/Jalali picker are not loaded on public pages; initial public-page JS ≤ ~150KB gzip
    - _Requirements: 9.3_
  - [ ] 11.2 Font and image optimization
  ...
  - [ ] 11.3 CWV verification + field reporting
...
- [ ] 12. Final checkpoint: green build + per-screen QA
  - [ ] 12.1 Full build and test sweep across workspaces
  ...
  - [ ] 12.2 Apply the Design QA and SEO QA checklists per screen
