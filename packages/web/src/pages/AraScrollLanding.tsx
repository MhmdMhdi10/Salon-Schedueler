...
const SCROLL_LANDING_DESCRIPTION =
  'آرا؛ تقویم شمسی، رزرو آنلاین، خدمات و ارتباط با مشتری‌ها برای سالن‌های زیبایی ایران.';
...
const SCROLL_FEATURES: ScrollFeature[] = [
  {
    id: 'calendar',
    number: '۰۱',
    eyebrow: 'تقویم شمسی آرا',
    title: 'کل روز کاری‌ات، یک‌جا جلوی چشمته.',
    description:
      'از اولین نوبت صبح تا آخرین مشتری شب، برنامه‌ات را با تقویم واقعی شمسی ببین؛ بدون برگه، پیام پراکنده یا حدس زدن.',
    bullets: [
      'نمای روز، هفته و ماه',
      'رنگ‌بندی ساده برای هر خدمت',
      'نمایش هم‌زمان روی دسکتاپ و گوشی',
    ],
    accent: 'teal',
  },
  {
    ...
    number: '۰۲',
    eyebrow: 'رزرو آنلاین',
    title: 'مشتری خودش وقت مناسب را انتخاب می‌کند.',
    description:
      'یک لینک رزرو از آرا در بیو یا واتساپت بگذار. مشتری خدمت و زمان خالی را می‌بیند و نوبت مستقیم وارد تقویمت می‌شود.',
    bullets: [
      'رزرو بدون نصب اپ',
      'لینک آماده برای اینستاگرام و واتساپ',
      'تأیید نوبت بدون تماس رفت‌وبرگشتی',
    ],
    accent: 'violet',
  },
  {
    ...
    title: 'خدماتت شفاف؛ انتخاب برای مشتری راحت.',
    description:
      'کوتاهی، رنگ، فیشال یا هر خدمت دیگری را با زمان و قیمت مشخص بچین تا مشتری قبل از رزرو دقیق بداند چه چیزی دریافت می‌کند.',
    bullets: [
      'ساخت منوی خدمات در چند دقیقه',
      'زمان و قیمت جدا برای هر خدمت',
      'کمتر شدن سؤال‌های تکراری',
    ],
    accent: 'blue',
  },
  {
    id: 'clients',
    number: '۰۴',
    eyebrow: 'مشتری‌های وفادار',
    title: 'رابطه با مشتری بعد از نوبت تمام نمی‌شود.',
    description:
      'اطلاعات مشتری‌ها و سابقهٔ خدماتشان را منظم نگه دار، یادآوری بفرست و کاری کن بازگشت بعدی‌شان از قلم نیفتد.',
    bullets: [
      'پروفایل و سابقهٔ هر مشتری',
      'یادآوری نوبت و پیگیری ساده',
      'تصمیم‌گیری بهتر برای رشد سالن',
    ],
    accent: 'rose',
  },
];
    ...
    >
      ...
      >
        ...
        <Link to="/business/register" className="ara-scroll-feature-link">
          این بخش را امتحان کن <ArrowUpLeft aria-hidden="true" />
        </Link>
      </motion.div>
    </section>
  );
...
export function AraScrollLanding() {
  ...
  return (
    ...
    >
      <SeoHead
        title="آرا؛ سالن منظم‌تر، مشتری راضی‌تر"
      ...
      <main className="ara-scroll-main">
          ...
          <div className="ara-scroll-hero-inner">
            ...
            >
              <span className="ara-scroll-eyebrow">
                <i aria-hidden="true" /> آرا برای سالن‌های ایران
              </span>
              ...
              <p>
                تقویم شمسی، رزرو از لینک بیو و مدیریت مشتری‌ها؛ همه‌چیز یک‌جا برای روز کاری منظم‌تر
                و مشتری‌های وفادارتر.
              </p>
              <div className="ara-scroll-hero-actions">
                ...
                >
                  شروع رایگان با آرا <ArrowUpLeft aria-hidden="true" />
                </Link>
                <a
                  href="#ara-scroll-calendar"
                  className="ara-scroll-button ara-scroll-button-secondary"
                >
                  دیدن آرا در عمل <ArrowDownLeft aria-hidden="true" />
                </a>
              </div>
              <div className="ara-scroll-hero-trust">
                ...
                <span>
                  <Check aria-hidden="true" /> رزرو بدون نصب اپ
                </span>
              </div>
            </motion.div>
        ...
        <div className="ara-scroll-story-intro" aria-hidden="true">
          <span>هر فیچر، یک حرکت کمتر در روز کاری تو</span>
          <i />
        </div>
        ...
        >
          <span className="ara-scroll-eyebrow">
            <i aria-hidden="true" /> آماده‌ای روز سالن را سبک‌تر کنی؟
          </span>
          <h2 id="ara-scroll-final-title">
            آرا را برای سالن خودت
            <span>رایگان شروع کن.</span>
          </h2>
          <p>یک تقویم مرتب، یک لینک رزرو و خیال راحت‌تر برای هر روز کاری.</p>
