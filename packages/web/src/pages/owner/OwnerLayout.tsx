 ...
 *     from the stored refresh token ({@link bootstrapAuth}) so a page refresh
 *     keeps the owner signed in. If no access token is already present and the
 *     refresh fails, the user is routed to the existing OTP login at `/auth`.
 ...
 *  3. **Sign-out:** clears the access + refresh tokens and returns to `/auth`.
 *
