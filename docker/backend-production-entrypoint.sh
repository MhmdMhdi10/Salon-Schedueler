...
for migration in \
  ...
  packages/backend/prisma/migrations/00000000000014_business_profile_and_clients/migration.sql \
  packages/backend/prisma/migrations/00000000000015_referral_mvp/migration.sql
do
