...
export function BookingSuccessPage() {
  ...
  const { serviceName, startAt, salonName, locationType, locationAddress } = details;
  const hasSummary = Boolean(serviceName || startAt || salonName || locationAddress);
          ...
          <section aria-labelledby="success-summary-title" className="w-full">
            ...
            <Card as="section" className="text-start">
              <dl className="flex flex-col divide-y divide-border">
                ...
                {locationAddress && locationType === 'customer' && (
                  <div className="flex flex-col items-start gap-1 py-2 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
                    <dt className="flex items-center gap-2 text-sm text-muted">
