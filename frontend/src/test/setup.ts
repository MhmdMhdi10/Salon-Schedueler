...
// axe-core probes canvas text metrics for its color-contrast rule. jsdom's
// default implementation throws a noisy "not implemented" error, even though
// these tests only need a deterministic metric stub.
