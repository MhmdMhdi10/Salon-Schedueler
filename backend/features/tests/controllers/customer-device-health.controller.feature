Feature: Customer, device, and health controller HTTP contracts
  Scenario: exercise customer self-service and device routes
    ...
    When I exercise controller endpoint "GET /customers/me/notifications"
    When I exercise controller endpoint "PATCH /customers/me/notifications/:id/read"
    When I exercise controller endpoint "POST /customers/me/notifications/read-all"
    When I exercise controller endpoint "POST /support/tickets"
    When I exercise controller endpoint "GET /support/tickets/mine"
